...
import AboutPageItem from '../components/AboutPageItem'

const aboutPokecenter = [
  {
    id: '1',
...
export const AboutPage: React.FC = () => {
  return (
    <Layout templateTitle="Quem Somos">
      <PageInfo title="Quem Somos" />
      <main className="container max-w-sm mx-auto">
        <div className="pt-8 pb-16 px-2 md:px-0">
          <h1 className="font-semibold text-lg mb-3">O Centro Pokémon</h1>
          {aboutPokecenter.map((item) => (
            <AboutPageItem key={item.id} aboutItem={item} />
          ))}
        </div>
      </main>
    </Layout>
